...
#+RESULTS:
| (company-irony-c-headers company-irony) | company-rtags | company-bbdb | company-nxml | company-css | company-eclim | company-clang | company-xcode | company-cmake | company-capf | company-files | (company-dabbrev-code company-gtags company-etags company-keywords) | company-oddmuse | company-dabbrev |
...
* COMMENT add the following to  .dir-locals.el
#+BEGIN_SRC emacs-lisp
